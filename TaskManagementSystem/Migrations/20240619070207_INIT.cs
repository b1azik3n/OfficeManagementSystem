        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeftDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "IncidentResolvingHistories",
                columns: table => new
                {
                    Attempt_Number = table.Column<int>(type: "int", nullable: false),
                    IncidentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AttemptedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AttemptMethod = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApproximateTime = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncidentTrackings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectUsers_Designations_DesignationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncidentResolvers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IncidentResolvers_Incidents_IncidentId",
                        column: x => x.IncidentId,
                        principalTable: "Incidents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IncidentResolvers_Resolvers_ResolverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncidentResolvers_IncidentId",
                table: "IncidentResolvers",
                column: "IncidentId");

            migrationBuilder.CreateIndex(
                name: "IX_IncidentResolvers_ResolverId",
                table: "IncidentResolvers",
                column: "ResolverId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectUsers_DesignationId",
                table: "ProjectUsers",
